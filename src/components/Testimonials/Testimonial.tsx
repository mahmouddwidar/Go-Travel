...
export default function Testimonial({ testimonial }: TestimonialProps) {
  return (
    <li className="relative ml-24 flex rounded-3xl bg-white py-14 pt-14 pr-12 pl-42 drop-shadow-[0px_0px_20px_rgba(0,0,0,0.05)]">
      <div className="after:bg-primary-700 absolute left-0 size-47.5 -translate-x-[50%] overflow-hidden after:absolute after:right-0 after:bottom-0 after:-z-1 after:block after:size-47 after:rounded-full">
        <img
          src={testimonial.img}
          alt={testimonial.alt}
