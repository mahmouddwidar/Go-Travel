  ...
  return (
    ...
    >
      <div className="max-mdlg:max-w-lg m-auto max-w-389">
        ...
        {!isLoading && !error && (
          <ul className="max-3xl:mt-31 max-3xl:gap-x-26 mt-33 grid grid-cols-3 gap-x-29 gap-y-24 max-2xl:mt-24 max-2xl:gap-x-16 max-2xl:gap-y-20 max-xl:mt-20 max-xl:grid-cols-2 max-xl:gap-x-22 max-lg:gap-x-12 max-md:mt-16 max-md:grid-cols-1 max-sm:gap-y-16">
